...
public class PowerUp extends JComponent implements Observer {
    private int x;
    private int y;
    ...
    public PowerUp(BufferedImage img, int x, int y, double vx, double vy, int lifeCount) {
        this.img = img;
        this.x = x;
        this.y = y;
        this.vx = vx;
        ...
        this.rec1.width = GameStarter.burger.getWidth();
        this.rec1.height = GameStarter.burger.getHeight();
        this.rec1.x = this.x;
        this.rec1.y = this.y;
